...
//   ),
//   // 参考文献源
//   bibliography: bibliography.with("ref.bib", style: "gb-7714-2005-numeric"),
// )
...
#let (
  ...
  doctype: "master",  // "bachelor" | "master" | "doctor" | "postdoc", 文档类型，默认为研究生 master
  // degree: "academic",  // "academic" | "professional", 学位类型，默认为学术型 academic
  // anonymous: true,  // 盲审模式
...
引用@tbl:timing，引用@tbl:timing-tlt，以及@fig:hdu-logo。引用图表时，表格和图片分别需要加上 `tbl:`和`fig:` 前缀才能正常显示编号。
...
#figure(
  image("../assets/hdu-emblem.png", width: 100%),
  caption: [图片测试],
) <hdu-logo>
...
// 致谢
#acknowledgement[
  感谢 NJU-LUG，感谢 modern-nju-thesis 模板。
]
